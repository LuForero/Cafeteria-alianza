...
<footer class="footer">
    <section style="padding: 4rem 2rem; margin: 0;">
    </section>
            ...
            <div class="row gy-5 gy-md-0 align-items-md-center">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                    <div class="copyright text-center text-md-start">
                        © 2025 Desarrollado por PIXEL.
                    </div>
                </div>

                <div class="credits text-secondary text-center text-md-start mt-2 fs-8 col-xs-12 col-md-5 order-0 order-md-1">
